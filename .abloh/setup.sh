...
# step 1: put the package manager on PATH, for your own lifecycle scripts. From pnpm-lock.yaml, pnpm@10.30.3
corepack enable

# step 2: dependencies, from your lockfile. From pnpm-lock.yaml, pnpm@10.30.3
corepack pnpm install --frozen-lockfile

# step 3: your build. From ci.yml::ci
pnpm build
